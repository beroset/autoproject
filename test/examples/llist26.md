...
This is a simple implementation of a singly linked list. As a noob I would like pointers on style and C conventions as well as functional pointers on memory management etc.  
